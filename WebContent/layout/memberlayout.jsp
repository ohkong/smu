...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="${path}/smu/member/main.me" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>&nbsp; 회원관리</a>
    <a href="" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>&nbsp; 공지사항</a>
    <a href="${path}/smu/board/list.do" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>&nbsp; 자유게시판</a>
    <a href="" class="w3-bar-item w3-button w3-padding"><i class="fa fa-share-alt fa-fw"></i>&nbsp; 자료실</a>
  </div>
</nav>
